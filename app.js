...
const LEVELS = {
  5: { label: '居住', full: '居住（居住过）', color: '#b85c5c' },
  4: { label: '短居', full: '短居（住宿过）', color: '#c8885a' },
  3: { label: '游玩', full: '游玩（游玩过）', color: '#c9a85c' },
  2: { label: '落脚', full: '落脚（休息、换车等）', color: '#6a9a92' },
  1: { label: '路过', full: '路过（路过）', color: '#8a9eb5' },
...
const MAP_SVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1134 976" role="img" aria-label="中国省级制霸地图">
  ...
  <g id="legend">
    <path class="legend-swatch" data-level="5" fill="#b85c5c" d="M983 450h120v50H983Z"/>
    <path class="legend-swatch" data-level="4" fill="#c8885a" d="M983 500h120v50H983Z"/>
    <path class="legend-swatch" data-level="3" fill="#c9a85c" d="M983 550h120v50H983Z"/>
    <path class="legend-swatch" data-level="2" fill="#6a9a92" d="M983 600h120v50H983Z"/>
    <path class="legend-swatch" data-level="1" fill="#8a9eb5" d="M983 650h120v50H983Z"/>

...
const LEVELS = {
  5: { label: '居住', color: '#e84c3d' },
  4: { label: '短居', color: '#d58337' },
  3: { label: '游玩', color: '#f3c218' },
  2: { label: '出差', color: '#30cc70' },
  1: { label: '路过', color: '#3598db' },
  0: { label: '没去过', color: '#ffffff' },
};

const MAP_SVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1134 976" role="img" aria-label="中国省级制霸地图">
  <rect id="map-bg" x="0" y="0" width="1134" height="976" fill="#9dc3fb"/>
  ...
  <g id="legend">
    <path class="legend-swatch" data-level="5" fill="#e84c3d" d="M983 450h120v50H983Z"/>
    <path class="legend-swatch" data-level="4" fill="#d58337" d="M983 500h120v50H983Z"/>
    <path class="legend-swatch" data-level="3" fill="#f3c218" d="M983 550h120v50H983Z"/>
    <path class="legend-swatch" data-level="2" fill="#30cc70" d="M983 600h120v50H983Z"/>
    <path class="legend-swatch" data-level="1" fill="#3598db" d="M983 650h120v50H983Z"/>
    <path class="legend-swatch" data-level="0" fill="#ffffff" d="M983 700h120v50H983Z"/>
...
function svgToBlobUrl() {
  ...
  if (bg) bg.setAttribute('fill', '#9dc3fb');

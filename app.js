...
/** Color-vision-safe palette; level order and URL encoding stay unchanged. */
const LEVELS = {
  5: { label: '居住', full: '居住（居住过）', color: '#c04d9e' },
  4: { label: '短居', full: '短居（住宿过）', color: '#df8d32' },
  3: { label: '游玩', full: '游玩（游玩过）', color: '#e7c94b' },
  2: { label: '落脚', full: '落脚（休息、换车等）', color: '#3b8cc4' },
  1: { label: '路过', full: '路过（路过）', color: '#4ecdc4' },
  0: { label: '没去过', full: '没去过', color: '#f7f5f0' },
};

const MAP_SVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1134 976" role="img" aria-label="中国省级制霸地图">
  <rect id="map-bg" x="0" y="0" width="1134" height="976" fill="#f0ebe3"/>
  ...
  <g id="legend">
    <path class="legend-swatch" data-level="5" fill="#c04d9e" d="M983 450h120v50H983Z"/>
    <path class="legend-swatch" data-level="4" fill="#df8d32" d="M983 500h120v50H983Z"/>
    <path class="legend-swatch" data-level="3" fill="#e7c94b" d="M983 550h120v50H983Z"/>
    <path class="legend-swatch" data-level="2" fill="#3b8cc4" d="M983 600h120v50H983Z"/>
    <path class="legend-swatch" data-level="1" fill="#4ecdc4" d="M983 650h120v50H983Z"/>
    <path class="legend-swatch" data-level="0" fill="#f7f5f0" d="M983 700h120v50H983Z"/>
    <path class="legend-border" fill="none" stroke="#2c2a26" stroke-width="4" d="M983 448h120v304H983Z"/>
